...
"isKindOf": function (value, constructor) {
...
"isArrayLike": function (object, stringAsArray) {
...
var accumulatedCalls = 0;
var tryCall = function (action) {

accumulatedCalls = (accumulatedCalls + 1) % async.maxAccumulatedCalls;
...
async.maxAccumulatedCalls = 1000;
